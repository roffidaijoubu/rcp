    ...
    <div class="flex overflow-y-scroll">
        ...
        <section class="flex flex-col overflow-x-scroll overflow-y-scroll gap-4 pb-5 shrink-0 ">
            ...
            <script>
                ...
                const borderColors = backgroundColors.map(color => color.replace('1)', '0.1)'));
        ...
        <section class="w-full flex flex-col items-center justify-center">
            ...
            <script>
                ...
                document.addEventListener('changeRadarChart', (e) => {
                    ...
                    fetch(`/api/audit/assessment/${satkerName}/${year}`)
                        ...
                        .then(data => {
                            ...
                            for (let key in data) {
                                ...
                                let borderColor = borderColors[labels.indexOf(key)];
                                // replace the transparent color with 0.05 opacity
                                let backgroundColor = backgroundColors[labels.indexOf(key)];
                                datasets.push({
                                    label: `${key}`,
                                    data: dataset,
                                    fill: true,
